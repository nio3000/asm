...
# instead, inherit from this class and extend its behaviour there.  
#
# Source file: gui/ui.xrc 
...
class XrcFrameMain < Wx::Frame
    ...
    attr_reader :mb_main, :mb_fm_new, :mb_fm_about, :mb_fm_exit 
    attr_reader :tb_main, :status_bar
    ...
    def initialize(parent = nil)
        ...
        xml.load(File.join(File.dirname(__FILE__),"templates/gui.xrc"))
        ...
        @mb_fm_about = finder.call("mb_fm_about")
